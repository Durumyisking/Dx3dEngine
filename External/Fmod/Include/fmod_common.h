...
#define FMOD_DEBUG_DISPLAY_LINenum classBERS              0x00020000
...
typedef enum class FMOD_CHANNELCONTROL_TYPE
{
...
typedef enum class FMOD_OUTPUTTYPE
{
...
typedef enum class FMOD_SPEAKERMODE
{
...
typedef enum class FMOD_SPEAKER
{
    FMOD_SPEAKER_NONE = -1,
...
typedef enum class FMOD_CHANNELORDER
{
...
typedef enum class FMOD_PLUGINTYPE
{
...
typedef enum class FMOD_SOUND_TYPE
{
...
typedef enum class FMOD_SOUND_FORMAT
{
...
typedef enum class FMOD_OPENSTATE
{
...
typedef enum class FMOD_SOUNDGROUP_BEHAVIOR
{
...
typedef enum class FMOD_CHANNELCONTROL_CALLBACK_TYPE
{
...
typedef enum class FMOD_CHANNELCONTROL_DSP_INDEX
{
...
typedef enum class FMOD_ERRORCALLBACK_INSTANCETYPE
{
...
typedef enum class FMOD_DSP_RESAMPLER
{
...
typedef enum class FMOD_DSP_CALLBACK_TYPE
{
...
typedef enum class FMOD_DSPCONNECTION_TYPE
{
...
typedef enum class FMOD_TAGTYPE
{
...
typedef enum class FMOD_TAGDATATYPE
{
...
typedef enum class FMOD_PORT_TYPE
{
