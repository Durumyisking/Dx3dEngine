...
#pragma region CityWorldHomeBuilding002
	...
	textureLoad(L"GlassBuildingWall00", L"CityWorldHomeBuilding/Image", TextureState::AlEmMtNrRg);
	textureLoad(L"RoofConcrete00", L"CityWorldHomeBuilding/Image", TextureState::AlNrRg);
	textureLoad(L"RoofConcrete01", L"CityWorldHomeBuilding/Image", TextureState::AlNrRg);
	textureLoad(L"WallGlassPaintedSteel00", L"CityWorldHomeBuilding/Image", TextureState::AlNr);
