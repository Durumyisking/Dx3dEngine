...
{
	// 오른쪽 기준
#define DEGREE_90 math::Vector3(0.f, 1.f, 0.f)
#define DEGREE_45 math::Vector3(0.707f, 0.707f, 0.f)
#define DEGREE_30 math::Vector3(0.866f, 0.5f, 0.f)
#define DEGREE_15 math::Vector3(0.966f, 0.259f, 0.f)
#define DEGREE_0 math::Vector3(1.f, 0.f, 0.f)
